 ...
 *
 * Turning a step off removes its screen and nothing else: the check it carried is still
 * made when the order is placed, by CheckoutValidationService.
 */
final readonly class CheckoutStepConfigurationService
{
    ...
    private function orderedSteps(): array
    {
        return iterator_to_array(
            CheckoutStepQuery::create()->orderByPosition()->orderByCode()->find(),
            false,
        );
    }
