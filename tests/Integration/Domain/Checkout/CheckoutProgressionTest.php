...
final class CheckoutProgressionTest extends IntegrationTestCase
{
    ...
    public function testTheStepsCarryTheWordingAndTheRenderingHintTheThemeNeeds(): void
    {
        $cart = $this->cartWithAnItem();
        ...
        self::assertSame('Organisms:Delivery:Base', $delivery->componentName);
    ...
    public function testPositionsPermutedInTheTableFallBackToTheStepsTheCodeDeclares(): void
    {
        ...
        $progression = new CheckoutProgressionService($this->stepProviders(), new CheckoutTunnelShape(), $logger);
        $cart = $this->cartWithAnItem();
